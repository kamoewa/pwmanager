...
root.config(padx=50, pady=50, bg=DARK_GREY)
...
# ROW 1
website_label = Label(text='Website:', bg=DARK_GREY, fg=BEIGE)
...
website_entry.insert(0, 'google')

# ROW 2
email_label = Label(text='Email/Username:', bg=DARK_GREY, fg=BEIGE)
...
# ROW 3
password_label = Label(text='Password:', bg=DARK_GREY, fg=BEIGE)
